...
<template>
  ...
  >
    ...
    <text
      ...
      class="fill-transparent stroke-neutral-200 text-7xl font-bold font-[helvetica] dark:stroke-neutral-800"
    >
      {{ text }}
    </text>
    ...
    <text
      ...
      :stroke-width="strokeWidth"
      mask="url(#textMask)"
      class="fill-transparent text-7xl font-bold font-[helvetica]"
    >
      {{ text }}
    </text>
  </svg>
